package com.example.vivobook.twoactivities;
...
//        onView(withId(R.id.text_message)).check(matches(withText("This is a failing test.")));
    ...
    //TEST FAILING
    @Test
    public void textInputOutput2() {
        onView(withId(R.id.editText_main)).perform(typeText("This is a test22."));
        onView(withId(R.id.button_main)).perform(click());
//        onView(withId(R.id.text_message)).check(matches(withText("This is a test.")));
        onView(withId(R.id.text_message)).check(matches(withText("This is a failing test.")));
    ...
    public void useAppContext() {
        ...
        assertEquals("com.example.vivobook.twoactivities", appContext.getPackageName());
    }
}
